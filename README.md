...
```javascript
FLOAT16_PRECISION = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-precision@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-precision@umd/bundle.js"></script>
```
